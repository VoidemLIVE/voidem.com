  ...
  <section class="timeline">
    ...
    <div class="timeline-list">
      <div class="timeline-item">
        <h4 class="h4 timeline-item-title"><a href="https://support.voidem.com" target="#">Voidem Development</a> - Owner</h4>
        <span>May 2021 — Present</span>
        <p class="timeline-text">
          My personal development project which creates Minecraft plugins and websites.
          <br><a style="color:white;">Skills:</a> Java, PHP, HTML, CSS, SQL, Python, JavaScript.
        </p>
      </div>
      <div class="timeline-item">
        <h4 class="h4 timeline-item-title"><a href="https://bundlegroup.gg/" target="#">Bundle Group LTD</a> - Volunteer Staff</h4>
        <span>Dec 2022 — Present</span>
        <p class="timeline-text">
          Volunteer moderator and developer. Bundle Group create unique Minecraft projects.
          <br><a style="color:white;">Skills:</a> Moderation, Java.
        </p>
      </div>
      <div class="timeline-item">
        <h4 class="h4 timeline-item-title"><a href="https://coastersandcrafters.com/" target="#">Coasters & Crafters LTD</a> - Moderator</h4>
        <span>Dec 2022 — Feb 2024</span>
        <p class="timeline-text">
          Moderating Coasters & Crafters' yearly event, Coaster Con. Now merged with Bundle Group LTD.
          <br><a style="color:white;">Skills:</a> Moderation.
        </p>
      </div>
      <div class="timeline-item">
        <h4 class="h4 timeline-item-title"><a href="https://greenwoodmc.net" target="#">Greenwood Parks</a> - Technical Director</h4>
        <span>Aug 2022 — Nov 2023</span>
        <p class="timeline-text">
          Managing the tech and dev team of Greenwood Parks. A Minecraft theme park server, now closed.
          <br><a style="color:white;">Skills:</a> Community management, System administration, Java.
        </p>
      </div>
      <br>
    </div>
